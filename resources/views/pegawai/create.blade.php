          ...
          <div class="card">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="uuid" value="{{ old('uuid') }}" placeholder="Masukkan UUID" required>
                </div>
                <div class="form-group">
                  <label for="name">Parent UUID</label>
                  <input type="text" class="form-control" name="parent_uuid" value="{{ old('parent_uuid') }}" placeholder="Masukkan Parent UUID" required>
                </div>
                <div class="form-group">
                  <label for="name">Company ID</label>
                  <input type="text" class="form-control" name="company_id" value="{{ old('company_id') }}" placeholder="Masukkan Company ID" required>
                </div>
                <div class="form-group">
                  <label for="name">Department Code</label>
                  <input type="text" class="form-control" name="department_code" value="{{ old('department_code') }}" placeholder="Masukkan Department Code" required>
                </div>
                <div class="form-group">
                  <label for="name">Name</label>
                  <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Masukkan Name" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="empl_id" value="{{ old('empl_id') }}" placeholder="Masukkan Empl ID" required>
                </div>
                <div class="form-group">
                  <label for="name">Join Date</label>
                  <input type="date" class="form-control" name="join_date" value="{{ old('join_date') }}" placeholder="Masukkan Join Date" required>
                </div>
                <div class="form-group">
                  <label for="name">Ext No</label>
                  <input type="text" class="form-control" name="ext_no" value="{{ old('ext_no') }}" placeholder="Masukkan Ext No" required>
                </div>
                <div class="form-group">
